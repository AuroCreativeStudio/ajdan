...
import logo from "./images/island.png";
import mobileBg from "./images/islandmobile.webp";
import bg from "./images/island.webp";
        ...
        <main className="w-full sm:w-[100%] md:w-[100%] lg:w-[100%] max-w-6xl mx-auto px-4 min-h-screen flex flex-col justify-center md:grid md:grid-cols-2 items-center text-white relative margintop">
          ...
          <div className="text-center md:pr-6 md:px-4 lg:px-12 md:text-left">
            <motion.h1
              ...
              className="leading-none text-white font-cyrillic font-regular"
            >
              <span
...
>
  {t("register_interest")}
            ...
            <form
              className="flex flex-col gap-2 font-cyrillic font-regular"
...
>
  ...
  <option value="+971">+971</option>
                  ...
                  <input
                    ...
                    className={`flex-1 h-11 text-[10px] text-white bg-[#39215C] rounded-sm border ${
                      errors.phone ? "border-red-500" : "border-[#C2995B]"
                    } focus:border-[#ffffff] focus:outline-none px-4 placeholder:text-[9px] placeholder:text-start placeholder:text-[#C2995B]
          [&::placeholder]:font-cyrillic
  ...
  className={`
    w-full h-11 bg-[#39215C] rounded-sm border custom-select4
    ${errors.moreDetailsCode ? "border-red-500" : "border-[#C2995B]"}
...
>
  <option
    value=""
    disabled
    className={i18n.language === "ar" ? "text-[14px]" : "text-[9px] text-[#C2995B]"}
  >
    {t("more_details")}
  </option>
  {MORE_DETAIL_OPTIONS.map((opt) => (
    ...
    >
      {opt.label}
                  ...
                  <span
                    className={`absolute top-1/2 -translate-y-1/2 text-[10px] text-[#C2995B] pointer-events-none ${
              ...
              {/* Submit */}
              <div className="p-[1px] rounded-sm bg-gradient-to-r from-[#FD5645] to-[#BA4F21] hover:bg-gradient-to-l transition-all duration-700 ease-in-out bg-clip-padding box-border">
                <button
                  type="submit"
                  disabled={submitting}
          ...
          <div className="max-w-[1340px] mx-auto px-6 flex items-center justify-center">
            {i18n.language === "ar" ? (
              ...
              <p className="text-[9px] text-center text-white font-cyrillic md:text-[10px]">
                ...
                <span className="font-cyrillic">|</span> ALL RIGHTS RESERVED.
              </p>
            )}
          </div>
        </div>
