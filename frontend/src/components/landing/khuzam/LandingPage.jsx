          ...
          >
            ...
            >
              <div className="bg-[#E9E5DD] p-6 text-center relative">
                <div className="mx-auto mb-4 h-10 w-10 rounded-lg grid place-items-center bg-[#DED6CB]">
                  <img
                    src={logoTile}
                    alt=""
...
const Khuzam = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const result = await getListingByIdentifier("khuzam", i18n.language);
        setData(result);
        console.log(result);
      } catch (error) {
...
<div
  ...
  style={{
    background:
      "linear-gradient(rgba(47, 43, 37, 0.6) 0%, rgba(138, 130, 117, 0.6) 57%, rgba(230, 217, 196, 0.3) 84%)",
  }}
/>
...
<div
  ...
  style={{
    background:
      "linear-gradient(rgba(47, 43, 37, 0.3) 0%, rgba(138, 130, 117, 0.5) 57%, rgba(230, 217, 196, 0.2) 84%)",
  }}
/>
